---
title: "Why You Can't Put Down Your Phone"
date: "2026-04-29"
excerpt: "The slot machine and the smartphone use the same neural circuit. This isn't a willpower problem — it's variable ratio reinforcement, the most addiction-resistant reward schedule ever identified."
tags: ["neuroscience", "dopamine", "smartphone addiction", "attention", "Japanese philosophy"]
readTime: 7
tldr:
  - "You can't stop checking because of dopamine prediction error circuits responding to uncertainty — not to the reward itself, but to the anticipation of a possible reward."
  - "Variable ratio reinforcement is the most extinction-resistant schedule known — slot machines and social media feeds are built on the same principle, deliberately."
  - "Buddhist *taṇhā* (craving) identified this mechanism 2,500 years ago — endless wanting is produced by a system that depends on uncertainty, not on the absence of reward."
sources:
  - name: "A neural substrate of prediction and reward, Schultz et al., Science, 1997"
    url: "https://pubmed.ncbi.nlm.nih.gov/9054347/"
  - name: "The 'online brain': how the Internet may be changing our cognition, Firth et al., World Psychiatry, 2019"
    url: "https://pubmed.ncbi.nlm.nih.gov/31059626/"
  - name: "Addiction: a disease of learning and memory, Hyman, Am J Psychiatry, 2005"
...
Pair this with the **Screen-Free Recovery Window** from the [Practice page](/protocols). When the impulse arrives, instead of opening the device, enter 15 minutes of screen-free time.
