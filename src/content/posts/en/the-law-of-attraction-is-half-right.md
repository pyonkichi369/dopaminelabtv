---
title: "The Law of Attraction Is Half-Right"
date: "2026-05-07"
excerpt: "Visualization does work — but not through mystical forces. Predictive coding, the Reticular Activating System, and confirmation bias are the real mechanisms. Understanding where the science ends and magical thinking begins can make you dramatically more effective."
tags: ["neuroscience", "law of attraction", "predictive coding", "RAS", "cognitive bias"]
readTime: 7
tldr:
  - "The Reticular Activating System (RAS) is a real brainstem filter that selectively gates what reaches conscious awareness — priming it with a clear goal causes it to surface relevant information that was always there but invisible."
  - "Predictive coding means the brain actively generates expectations and then looks for confirming evidence — visualization makes the expected future more neurologically 'real' and guides attention toward it."
  - "Where the Law of Attraction fails is in treating attention as causation. Visualization without action cannot generate results, and passive positive thinking can actually reduce motivation by reducing the brain's sense of 'unfinished work.'"
sources:
  - name: "A theory of cortical responses, Philosophical Transactions of the Royal Society B, 2005"
    url: "https://pubmed.ncbi.nlm.nih.gov/15937014/"
  - name: "When positive thinking doesn't work: mental contrasting outperforms positive fantasizing, Journal of Experimental Social Psychology, 2011"
    url: "https://pubmed.ncbi.nlm.nih.gov/21237516/"
  - name: "The reticular activating system, neuronal mechanisms and behavioral functions, Progress in Neurobiology, 1991"
    url: "https://pubmed.ncbi.nlm.nih.gov/1850053/"
---
