...
export const POST_PAIRS: PostPair[] = [
  ...
  { en: 'morning-sluggishness-is-not-being-a-night-owl', ja: 'asa-ugokenai-nowa-yogata-dakara-janai' },
  ...
  { en: 'sugar-cravings-are-not-a-willpower-problem', ja: 'amai-mono-ga-yamerarenai-nowa-ishi-no-mondai-janai' },
